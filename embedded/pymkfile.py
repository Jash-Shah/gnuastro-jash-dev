...
all: $(PROGRAMS)
"""
configopts['pythonlib'] = distutils.sysconfig.get_config_var(
    'LIBPL') + '/' + distutils.sysconfig.get_config_var('LIBRARY')
...
configopts['pylibs'] += distutils.sysconfig.get_config_var('MODLIBS') + ' ' + distutils.sysconfig.get_config_var(
